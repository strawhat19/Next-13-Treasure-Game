          ...
          <header>
            <nav className="inner">
              <Link className={`logo hoverLink`} href={`/`}>
                <Image className={`logo reactLogo`} priority src={`/react.svg`} alt={`Logo`} width={`50`} height={`50`} />
                <Image className={`logo`} priority src={`/piratechs.svg`} alt={`Logo`} width={`50`} height={`50`} /> Home
              </Link>
