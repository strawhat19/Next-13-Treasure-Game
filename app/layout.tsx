...
export default function RootLayout({ children, } : { children: React.ReactNode; }) {
  ...
  let [state, setState] = useState({ user, page, updates, devEnv, content });
  ...
  useEffect(() => {
    ...
    setState({ user, page, updates, devEnv, content });
  ...
  return (
    <html lang="en">
      <StateContext.Provider value={{state, setState, width, setWidth, user, setUser, page, setPage, mobileMenu, setMobileMenu}}>
        <head>
        ...
        <body className={page}>
          <header>
            <nav className="inner">
              ...
              <ul className={`menu ${(mobileMenu && width < 1240) ? `grid mobileNav` : width < 1240 ? `hide` : `show`}`}>
              ...
              {width < 1240 && <div className="mobileMenu">
