...
export default function RootLayout({ children, } : { children: React.ReactNode; }) {
  ...
  return (
    <html lang="en">
      <StateContext.Provider value={{updates, setUpdates, content, setContent, width, setWidth, user, setUser, page, setPage, mobileMenu, setMobileMenu, users, setUsers, authState, setAuthState, emailField, setEmailField, devEnv, setDevEnv}}>
        <head>
